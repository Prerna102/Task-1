...
def process_pdf_page_sync(
    ...
    try:
        ...
        print(
            f"PAGE {page_number}:OCR Completed",
            flush=True,
        )
...
async def process_pdf(
    ...
    """
    Process a multipage PDF one page at a time.

    PDF rendering and PaddleOCR are blocking operations,
    so each page is processed in a thread.
    """
